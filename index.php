	...
	<div class="container">
		...
		<div id="formDiv">
			...
			<form method="post" name="frm" style="margin-top:40px" autocomplete="off">
				...
				<a href="index.php" class="focus">	<input type="button"  name="userlogin" value="User Login" class="btn btn-primary" style="width:180px"> </a> <br> <br>

				<a href="admin.php">	<input type="button"  name="adminlogin" value="Admin Login" class="btn btn-primary" style="width:180px"> </a>
...
<footer>
	...
	<div class="container text-left setcol">
