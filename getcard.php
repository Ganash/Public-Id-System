...
<div class="myheader">          
 ...
 <a href="personalcard.php"> <input type="button"  name="personal" value="Personal Details" class="btn btn-primary" style="width:180px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <!--  <a href="forgot_password.php"> Forget Password?</a> -->


 <a href="votercard.php"> <input type="button"  name="votercard" value="Voter Card" class="btn btn-primary" style="width:180px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;


 <a href="drivingcard.php"> <input type="button"  name="driving" value="Driving Liscence" class="btn btn-primary" style="width:180px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  

 <a href="passport.php"> <input type="button"  name="passport" value="Passport Details" class="btn btn-primary" style="width:180px" onclick=""> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
