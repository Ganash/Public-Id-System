...
<div class="jumbotron" style="margin-top:50px" >
  ...
  <div class="myheader"> 
 <a href="upload.php"> <input type="button"  name="upload" value="Upload" class="btn btn-primary" style="width:180px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <!--  <a href="forgot_password.php"> Forget Password?</a> -->


 <a href="getcard.php"> <input type="button"  name="getcard" value="Get Card" class="btn btn-primary" style="width:180px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<!--

 <a href="renewal.php"> <input type="button"  name="renewal" value="Renewal" class="btn btn-primary" style="width:180px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  

 <a href="modify.php"> <input type="button"  name="modify" value="Update" class="btn btn-primary" style="width:180px" onclick=""> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
