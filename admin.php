...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$myadminid=mysqli_real_escape_string($conn,$_POST['adminid']);
   ...
   echo $mypassword;
	...
	$sql="SELECT adminid FROM adminform WHERE adminid= '$myadminid' and password = '$mypassword' ";
...
<div class="signup" onclick="location.href='adminregister.php';">
				...
				<div class="jumbotron" style="margin-top:50px">
					...
					<div class="form-group" >
						...
						<div class="input-group">
							...
							<input type="text" name="adminid" class="form-control" placeholder="Admin ID" value="<?php echo @$_SESSION['adminid']; ?>" maxlength="50" required="required"> 
						</div>
						<span class="text-danger"><?php echo $adminError; ?></span>
					</div>	
