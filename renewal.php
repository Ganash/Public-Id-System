...
<div class="jumbotron" style="margin-top:100px" >
 ...
 <a href="drivingcard.php"> <input type="button"  name="driving" value="Driving Liscence" class="btn btn-primary" style="width:400px"> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  

 <a href="passport.php"> <input type="button"  name="passport" value="Passport Details" class="btn btn-primary" style="width:400px" onclick=""> </a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
