...
if (empty($mobile)) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO loginform(username,useremail,usermobile,userpassword) VALUES('$name','$email','$mobile','$pass')";
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
   ...
   ?>
			...
			<div id="formDiv">
				...
				<a href="terms.php">I am agree with terms and conditions</a><br/><br/>
